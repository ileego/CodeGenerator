...
namespace CodeGenerator.Infra.Common.Filters
{
    /// <summary>
    ...
    public sealed class CustomExceptionFilterAttribute : ExceptionFilterAttribute
    {
        ...
        public override void OnException(ExceptionContext context)
        {
            ...
            else
            {
                ...
                detail = _env.IsDevelopment() ? ExceptionHelper.GetExceptionDetail(exception) : $"系统异常,请联系管理员({eventId})";
                _logger.LogError(eventId, exception, exception.Message, requestUrl, userContext.User.UserId);
            }
