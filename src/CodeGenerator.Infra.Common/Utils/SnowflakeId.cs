    ...
    public class SnowflakeId
    {
        ...
        public static SnowflakeId Default()
        {
            lock (SLock)
            {
                ...
                if (!int.TryParse(Environment.GetEnvironmentVariable("SNOW_WORKERID", EnvironmentVariableTarget.Machine), out var workerId))
                {
                    workerId = random.Next((int)MaxWorkerId);
                }

                if (!int.TryParse(Environment.GetEnvironmentVariable("SNOW_DATACENTERID", EnvironmentVariableTarget.Machine), out var datacenterId))
                {
